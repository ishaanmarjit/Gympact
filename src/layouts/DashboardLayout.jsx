...
function DashboardLayout({ children }) {
  ...
  return (
    <div className="lg:flex w-screen min-h-screen h-full bg-gray-900">
      <aside
        id="desktop-menu"
        className="hidden lg:flex bg-gray-800 px-4 2xl:px-12 py-20 flex-col items-center justify-between"
      >
      ...
      <section className="bg-gray-900 w-full px-5 lg:px-20 py-10 pt-24 lg:pt-10 flex items-start justify-start">
        {children}
      </section>
    </div>
  );
