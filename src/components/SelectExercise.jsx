    ...
    <>
      <div className="bg-gray-700 p-4">
        <div className="w-full">
          <div className="flex space-x-2 items-center bg-gray-700">
            <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-gray-100 sm:mx-0 sm:h-10 sm:w-10 bg-gray-700">
              <Icon type="fitness" />
            </div>
