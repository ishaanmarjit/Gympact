  ...
  return (
    <div className="space-y-10 w-full">
      ...
      <main className="lg:flex lg:space-x-10 space-y-5 lg:space-y-0">
        ...
        <section className="flex-grow bg-gray-700 rounded-xl lg:flex">
          <div className="p-10 space-y-10">
            <h2 className="font-strong text-lg text-secondaryDark">CALORIES</h2>
            <div className="space-y-1">
              <h5 className="font-light text-sm text-secondaryDark">TODAY</h5>
              <h3 className="font-light text-6xl text-white">
                {isFetchingWorkouts ? 0 : parseInt(calories.today)}
              </h3>
            </div>
            <div className="space-y-1">
              <h5 className="font-light text-sm text-secondaryDark">
                THIS WEEK
              </h5>
              <h3 className="font-light text-6xl text-white">
